        ...
        <section class="contact-section" style="margin-left:25%">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <form class="form-contact contact_form" action="../qna/qna_upok.do" method="post" id="qabtn" novalidate="novalidate">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <textarea class="form-control w-100" name="content" id="content" cols="30" rows="9" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Content'" placeholder=" Enter Message">${vo.content }</textarea>
                                    </div>
                                </div>
                            ...
                            <div class="form-group mt-3">
                                <input type="submit" class="boxed-btn" value="Edit" id="insertqbtn">
